...
class Dialog(models.Model):
    ...
    user_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='dialogs' )
...
class Message(models.Model):
    ...
    dialog_id = models.ForeignKey(Dialog, on_delete=models.CASCADE, related_name='messages' )
